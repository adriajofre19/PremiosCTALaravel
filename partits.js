...
function insertInDataBase(partits) {
    ...
    partits.forEach(partit => {
        ...
        ganador,
        arbitre,
        AmarillasJugadoresLocal, RojasJugadoresLocal, AmarillasCuerpoTecnicoLocal,RojasCuerpoTecnicoLocal,AmarillasJugadoresVisitante,RojasJugadoresVisitante,AmarillasCuerpoTecnicoVisitante,RojasCuerpoTecnicoVisitante
         */
